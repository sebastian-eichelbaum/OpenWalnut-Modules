...
#ifndef WBOYGLOBALCOLORING_H
#define WBOYGLOBALCOLORING_H

#include <core/common/WObjectNDIP.h>

#include "WColoring_I.h"

class WBoyGlobalColoring : public WObjectNDIP< WColoring_I >
{
public:
    /**
     * Constructor.
